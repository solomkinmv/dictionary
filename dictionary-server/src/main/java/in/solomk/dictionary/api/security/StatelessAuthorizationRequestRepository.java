...
//
//@Component
//public class StatelessAuthorizationRequestRepository implements ServerAuthorizationRequestRepository<OAuth2AuthorizationRequest> {
//
...
//
//    public StatelessAuthorizationRequestRepository() {
//        this.encryptionKey = EncryptionHelper.generateKey();
//    }
//
//    public StatelessAuthorizationRequestRepository(@NonNull char[] encryptionPassword) {
